cdef extern from "void_openmp_library.h":
      ...
      int num_voids_around2(float void_overlap, int Ncells, int i, int j, int k, 
                            int xdim, int ydim, int zdim, int yzdim, 
                            float R_grid, float R_grid2, 
                            char *in_void, int threads);

      void mark_void_region(char *in_void, int Ncells, 
                            int xdim, int ydim, int zdim,
      ...
      int num_voids_around2_wrap(float void_overlap, int Ncells, int i, int j, int k, 
                                 int xdim, int ydim, int zdim, int yzdim, 
                                 float R_grid, float R_grid2, 
                                 char *in_void, int threads);

      void mark_void_region_wrap(char *in_void, int Ncells, 
                                 int xdim, int ydim, int zdim,
                                 int yzdim, float R_grid2, 
                                 int i, int j, int k, int threads);
